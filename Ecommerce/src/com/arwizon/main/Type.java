...
import com.arwizon.model.ServiceInterface;
import com.arwizon.model.ServiceInterfaceImp;
...
public class Type {
		...
		public static void main(String[] args) throws MyException 
		{
			...
			System.out.println("Press 1 to add new product press "+"\n 2. to display product details press"+"3.\n to search press"+"4.\n to update press"+" 5.\n to delete press 6 to exit");
